...
! ----- file for solution -----
      open(8,file='sol_serk.out')
      rewind 8
      open(9,file='sol_serk_xy.out')
      rewind 9
...
c-----------------------------
      ...
      call ESERK4(neqn,t,tend,h,y,fcombustion,atol,spcrad,iwork,
     *           work,idid)
      call itime(now)    ! now(1)=hour, (2)=minute, (3)=second
...
c       write(6,*) 'Max estimation of the spectral radius=',iwork(11)
c      write(6,*) 'Min estimation of the spectral radius=',iwork(12)
