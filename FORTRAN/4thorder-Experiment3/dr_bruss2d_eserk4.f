...
! ----- call of the subroutine SERK -----
      call ESERK4(neqn,t,tend,h,y,fbrus,atol,spcrad,iwork,work,idid)
      call itime(now)    ! now(1)=hour, (2)=minute, (3)=second
...
c       write(8,*) ((y(((j-1)*ns+i)*2-1),i=1,ns),j=1,ns)
c       write(8,*) ((y(((j-1)*ns+i)*2),  i=1,ns),j=1,ns)
...
c------------------------------------------------------
      ...
      do j=1,ns
        do i=1,ns
          write(8,*) ((y(((j-1)*ns+i)*2-1)))
        end do
      end do
       write(8,*) "****************"
      do i=1,ns
        do j=1,ns
          write(8,*) j,((y(((j-1)*ns+i)*2)))
        end do
      end do
      !end do
