                                                            ...
                                                            shared(start,al1,g,b,dt,t,neqn,y,feval,highest_order,stage,stage_intern)  firstprivate(g_calc,g_save,g_help) 
      {
        ...
        { 
            ...
            if (t > 0)
            {
                ...
                feval = feval + 1;
                for (int l = 0; l < neqn; l++){g_save[l] = g_calc[l];} 
            }
            for (int j = 1; j <= i1; j++)
            {
                r = x0n; //3-copy
                ...
                for (int i = 1; i <= (stage / stage_intern); i++)
                {
                    ...
                    {   
                        for (int l = 0; l < neqn; l++){g_help[l] = g_work[i_1_stage_intern][l]; }   //calculate and copy 5th copy 
                    ...
                    for (int k = 2; k <= stage_intern; k++)
                    {
                        ...
                        for (int l = 0; l < neqn; l++){g_help[l] = g_work[k_i_1_stage_intern-1][l];}
                        f(neqn, r, g_help, g_calc); 
                        feval = feval + 1;
                    
                        for (int l = 0; l < neqn; l++)
                        {
                            g_work[k_i_1_stage_intern][l] = 2.0 * g_work[k_i_1_stage_intern-1][l]- g_work[k_i_1_stage_intern-2][l] +  pas_al1_2 * g_calc[l];
                        }
